...
// //     title: "Documentation — Helyx",
// //     description: "Documentation for Helyx Database Replication.",
// //     alternates: {
// //         canonical: "https://helyx.quobotic.com/documentation/pgtopg"
// //     }
// // };
...
import PostgreSQLReplicationDocs from './pgtopg.client'

export const metadata = {
    title: "Documentation - PostgreSQL — Helyx",
    description: "PostgreSQL to PostgreSQL Replication Documentation for Helyx.",
    alternates: {
        canonical: "https://helyx.quobotic.com/documentation/pgtopg"
    }
};
                    ...
                    __html: JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                ...
                                "position": 2,
                                "name": "Documentation",
                                "item": "https://helyx.quobotic.com/documentation/pgtopg"
                            }
                        ]
                    })
                }}
            />
            <PostgreSQLReplicationDocs />
        </>
    )
}

export default PgtoPgPage

...
//     title: "Pricing — Helyx",
//     description: "Compare Helyx plans: Free trial, Starter, Professional and Enterprise.",
//     alternates: {
//         canonical: "https://helyx.quobotic.com/pricing"
//     }
// };
...
//     id: string;
//     title: string;
//     annualPrice?: number | null; // yearly total in USD (null for custom/enterprise)
//     priceLabel?: string; // fallback string label (e.g., "Custom")
//     period?: string;
//     highlights: string[];
//     cta: string;
//     featured?: boolean;
...
//                         Toggle between monthly or annual billing. Annual plans save you
//                         money compared to paying month-to-month.
//                     </p>
...
//                             className={`px-4 py-2 text-sm font-medium rounded-md cursor-pointer ${showMonthly
//                                     ? "bg-background shadow-sm/20"
...
//                             className={`px-4 py-2 text-sm font-medium rounded-md cursor-pointer ${isAnnual
//                                     ? "bg-background shadow-sm/20"
//                                     : "hover:bg-background/50"
//                                 }`}
//                         >
...
//                         const monthly =
//                             isCustom || annual === 0 ? 0 : roundToHundred(annual / 12);
...
//                             <Card
//                                 key={plan.id}
//                                 className={`relative flex flex-col h-full rounded-2xl border transition-transform hover:scale-105 ${plan.dark
//                                         ? "bg-neutral-900 text-white"
//                                         : "bg-white shadow-md/20"
//                                     }`}
//                             >
...
//                                             {displayPrice}
//                                         </span>
//                                         {/* {showMonthly && plan.annualPrice != null && (
...
//                                             Annual Saving: {formatUSD(annualSaving)}
//                                         </p>
//                                     )}
//                                 </CardHeader>
...
//                                                 <span
//                                                     className={`shrink-0 mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full ${plan.dark
...
// Export metadata from a server component (good for SEO & social)
export const metadata: Metadata = {
    title: "Pricing — Helyx",
    description: "Compare Helyx plans: Free trial, Starter, Professional and Enterprise.",
    alternates: {
...
// Render the client-only UI component as a child
// Note: This import is a client component below (pricing.client.tsx)
                    ...
                    __html: JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                ...
                                "position": 2,
                                "name": "Pricing",
                                "item": "https://helyx.quobotic.com/pricing"
                            }
                        ]
                    })
                }}

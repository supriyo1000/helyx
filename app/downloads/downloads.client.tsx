...
const DOWNLOADS: { id: string; label: string; path: string; filename: string; notes?: string }[] = [
    { id: "linux centos 8", label: "linux centos 8 (x86_64)", path: "/rpms/helyx-1.1.0-1.el8.x86_64.rpm", filename: "helyx-1.1.0-1.el8.x86_64.rpm", notes: "Free for 30 days" }
]
    ...
    return (
        <>
            <div className="container mx-auto">
                ...
                <h4 className="font-bold mt-6 mb-4 px-4 lg:px-8">For <span className="text-sky-800">PostgreSQL</span> to <span className="text-sky-800">PostgreSQL</span> Replication </h4>

                <p className="text-sm text-gray-700 dark:text-gray-400 mb-6 px-4 lg:px-8">Select your target Linux version to download the RPM. You can view the available versions without logging in. To start a download, you must be a registered user.</p>
                ...
                <div className="flex flex-col justify-center items-center mt-8 text-sm text-lime-800">

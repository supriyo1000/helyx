...
export function CommunitySection() {
    ...
    return (
        <section className="relative z-10 gap-2 w-full flex flex-col items-center mt-26 lg:mt-44 lg:px-8">
            <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-3">
                    {communities.map((community, index) => (
                        <Card
                            key={index}
                            className="border-transparent bg-white/5 dark:bg-default-400/10 backdrop-blur-lg backdrop-saturate-[1.8] cursor-pointer hover:scale-[0.97] transition-transform shadow-md/40 hover:shadow-xl rounded-lg">

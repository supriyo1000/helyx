    ...
    return (
        <section className="flex flex-col items-center justify-center">
            <div className="flex flex-col lg:flex-row relative overflow-hidden lg:overflow-visible w-full flex-nowrap justify-between items-center h-full lg:h-[calc(100vh_-_18vh)] 2xl:h-[calc(84vh_-_64px)] max-w-7xl mx-auto lg:px-6 mt-8">
                ...
                <div className="relative z-20 flex flex-col w-full gap-6 lg:w-1/2 h-[calc(100vh_-_25vh)] pt-20 lg:h-auto">
                        <div className="flex justify-center w-full md:hidden">
                            <a
                                href="/blog/v2.8.0"
                ...
                <div className="flex flex-col relative z-20 w-full lg:w-1/2 justify-center items-center mt-18 lg:mt-0">
